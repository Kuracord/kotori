...
module.exports = function register(client) {
  ...
  return class API {
    static async sendMessage(channelId, content, options = {}) {
      ...
      return await axiosWithToken(`https://api.kuracord.tk/api/v3/channels/${channelId}/messages`, options)
    }
    /*
    * Kuracord API doesn't support interactions, so this should be removed
